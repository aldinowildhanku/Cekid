...
<script>
    ...
    if (idml == '' && serverid == '') {
        ...
        jQuery.ajax({
            ...
            success: function(nickml) {
                var response_status = nickml.status;
                var namav = nickml.nama;
                var output = namav;
...
<div class="container">
  ...
  <form action="/action_page.php">
    ...
    <input type="button" class="btn btn-success" onclick="checkIDML()" value="CEK NICKNAME" />
  </form>
</div>
