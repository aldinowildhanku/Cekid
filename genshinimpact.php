...
<script>
    ...
    if (idgenshin == '' && serverid == '') {
        ...
        jQuery.ajax({
            ...
            success: function(nickgenshin) {
                var response_status = nickgenshin.status;
                var namav = nickgenshin.nama;
                var output = namav;
  ...
  <form action="/action_page.php">
    ...
    <div class="form-group">
      ...
      <select id="server_id" name="server_id" class="form-control"
                                            ...
                                            <option value="-1" disabled="" selected="">Pilih Server</option>
    ...
    <input type="button" class="btn btn-success" onclick="checkIDGenshin()" value="CEK NICKNAME" />
  </form>
</div>
