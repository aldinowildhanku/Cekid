...
if(@$_POST['user_id'] && @$_POST['server_id'] != NULL){
    ...
    $random_1 = random('5');
    $waktu = waktu();
    $query = "voucherPricePoint.id=116052&voucherPricePoint.price=16000.0&voucherPricePoint.variablePrice=0&n=$waktu&email=din0812$random_1%40store.com&userVariablePrice=0&order.data.profile=eyJuYW1lIjoiICIsImRhdGVvZmJpcnRoIjoiIiwiaWRfbm8iOiIifQ==&user.userId=$target_id&user.zoneId=$zoneid&msisdn=0213829389&voucherTypeName=GENSHIN_IMPACT&shopLang=id_ID&checkoutId=a7c6a645-81fa-4d97-8ca7-54bb1a16d35c&affiliateTrackingId=&impactClickId=&anonymousId=0070f667-d075-4559-b6e5-77090a6c6453&fullUrl=https%3A%2F%2Fwww.codashop.com%2Fid-id%2Fgenshin-impact&userSessionId=YWxkaW5vd2lsZGhhbjFAZ21haWwuY29t&userEmailConsent=true&userMobileConsent=false&verifiedMsisdn=&promoId=&promoCode=&clevertapId=3e0da1c3a1df4c14ba1e9fe9cc610f28&exUserInfo=$server";
